...
const FlightDashboard = () => {
  ...
  const dashboardItems = [
    { title: "Add Flight", link: "/add-flight", color: "flight", icon: <FaPlane /> },
    { title: "View Flights", link: "/display-flights", color: "booking", icon: <FaListUl /> },
    { title: "Search Flight", link: "/search-flight", color: "route", icon: <FaSearch /> }
  ];
